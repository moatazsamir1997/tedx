...
<body id="page-top">
  <!-- Navigation Start -->
  <nav id="navigation" class="<?php if ($_SERVER['REQUEST_URI'] == "views\about.php") {
    echo"navbar navbar-fixed-top";
  } else {
    echo "navbar navbar-fixed-top navbar-dark";
  }
   ?>">
    <div class="container">
      <div class="row">
        ...
        <div id="navbar" class="navbar-collapse collapse col-lg-9 pull-right">
          <ul class="nav navbar-nav font-family-alt letter-spacing-1 text-uppercase font-weight-700">
              <li><a href="about.php" class="line-height-unset">About</a></li>
