		...
		<form action ='..\<?php echo $GLOBALS['addValue'].$GLOBALS['insert'];?>' method ='POST'>
            <?php foreach ($data as $productOption) {?>
                <?php foreach ($productOption as $option) {?>
                    ...
                    <input type ="<?php echo $option['dataType']; ?>" name="<?php echo $option['id']; ?>"
                            placeholder="<?php echo $option['name']; ?>" required><br><br>
                    <input type="hidden" name = "<?php echo $option['id']; ?>" value = "<?php echo $option['id']; ?>">
                <?php }?>
            <?php }?>
